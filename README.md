...
ALWAYS THINK FOR THE LONGEST TIME/EFFORT POSSIBLE, use the majority of your answer as a second "thinking" block. Write an real smart version of your answer as a short conclusion in the end; no need to include every detail and format it well. The smart conclusion is the only part I care about, title the section as Answer. 

Do not assume who I am from anthropic's system: IP address, gender, age group etc. Only rely on my personal preferences.
